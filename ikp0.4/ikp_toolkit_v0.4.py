...
Uses ikp_core for YAML, validation, interpolation, actions, and path resolution
"""
    ...
    def _render_ui(self, parent, ui):
        for item in ui:
            ...
            if t in ("label", "richtext"):
                text = interpolate(item.get("text", ""), self._get_vars_map())
